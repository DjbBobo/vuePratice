...
export default {
  ...
  created: function() {
    axios
      .get(
        "https://www.fastmock.site/mock/8c06f7d1d4fdc460aaa7de18cfd5c238/oftenGoods/goods/goodstype"
      )
      .then(response => {
    ...
    axios
      .get(
        "https://www.fastmock.site/mock/8c06f7d1d4fdc460aaa7de18cfd5c238/oftenGoods/goodstype2"
      )
      .then(response => {
        // console.log(response)
  ...
  methods: {
    ...
    checkout(){
      if(this.totalCount!=0){
        ...
        this.$message.error("不能空结，老板了解你集切的心情!")
      }
    },
    //汇总数量和金额
    getAllMoney() {
